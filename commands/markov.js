...
module.exports = {
    main: async function (Bot, m, args) {
      ...
      function(err, tone) {
        ...
        var tone1 = "Average Emotional Tone: ***" + topTones.emotion.name + "***  | Score " + topTones.emotion.percent + "%"
        var tone2 = "Average Language Tone: ***" + topTones.language.name + "***  | Score " + topTones.language.percent + "%"
        var tone3 = "Average Social Tone: ***" + topTones.social.name + "***  | Score " + topTones.social.percent + "%"
        Bot.createMessage(m.channel.id, "Users Tones: " + "\n" +  tone1 + "\n" + tone2 + "\n"+ tone3);
